...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "flex items-center gap-2 rounded-lg p-2 text-sm text-muted-foreground hover:text-foreground transition-all outline-none data-active:text-foreground focus:bg-muted focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-md data-active:underline underline-offset-4 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
